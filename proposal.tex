...
\usepackage[style=authoryear-comp, bibstyle=authortitle, citestyle=authoryear-comp, maxcitenames=1, maxbibnames=100, sorting=nty, uniquelist=false, backend=biber]{biblatex}
