...
% Set the margins of the document memoir style
\setlrmarginsandblock{2cm}{2cm}{*}
\setulmarginsandblock{2cm}{*}{1}
\checkandfixthelayout 
\DisemulatePackage{setspace}            % Make sure package is not ignored by memoir class      
...
\begin{wrapfigure}{R}{0.5\textwidth} % R - floating; r - h!
  \centering
