...
\begin{figure}[!ht]
  ...
  \subbottom[Flow chart]{%
    \includegraphics[width=0.48\textheight]{wp_flow_chart}
  \label{fig:flowchart}}\\
  \subbottom[Gantt chart]{%
    \includegraphics[width=0.48\textheight]{gantt_chart}
...
\section{WP4 Production runs \& climate projections}
\label{sec:wp4}
